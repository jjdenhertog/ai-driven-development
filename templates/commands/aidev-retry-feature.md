...
1. Load correction report from `.ai-dev/corrections/${FEATURE_ID}-corrections.md`
...
Create `.ai-dev/sessions/[timestamp]/retry-context.md`:
```markdown
...
### Comparison:
See detailed comparison in: .ai-dev/sessions/${SESSION}/comparison.md
